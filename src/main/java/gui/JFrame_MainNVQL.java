...
public class JFrame_MainNVQL extends javax.swing.JFrame {
    ...
    public JFrame_MainNVQL(Account tk) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbl_thucDon = new javax.swing.JLabel();
        ...
        lbl_thucDon.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lbl_thucDon.setForeground(new java.awt.Color(255, 255, 255));
        lbl_thucDon.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lbl_thucDon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagesAndIcon/menu_1.png"))); // NOI18N
        lbl_thucDon.setText("   Thực đơn");
        lbl_thucDon.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbl_thucDonMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                lbl_thucDonMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                lbl_thucDonMouseExited(evt);
            }
        });
        ...
        lbl_nhanVien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagesAndIcon/manager.png"))); // NOI18N
        ...
        lbl_thongKe.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagesAndIcon/analytics.png"))); // NOI18N
        ...
        pnl_MenuLayout.setHorizontalGroup(
            ...
            .addGroup(pnl_MenuLayout.createSequentialGroup()
                .addGroup(pnl_MenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbl_thucDon, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        pnl_MenuLayout.setVerticalGroup(
            ...
            .addGroup(pnl_MenuLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lbl_thucDon, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void lbl_nhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_nhanVienMouseClicked
        clearLable();
        pressLable(lbl_nhanVien);
        pnl_Main.add(new panel_QuanLiNhanVien(), "quanlinhanvien");
        card.show(this.pnl_Main, "quanlinhanvien");
    ...
    private void lbl_thongKeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_thongKeMouseExited
        restoreLable(lbl_thongKe);
    }//GEN-LAST:event_lbl_thongKeMouseExited

    private void lbl_thucDonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_thucDonMouseEntered
        hoverLable(lbl_thucDon);
    }//GEN-LAST:event_lbl_thucDonMouseEntered

    private void lbl_thucDonMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_thucDonMouseExited
        restoreLable(lbl_thucDon);
    }//GEN-LAST:event_lbl_thucDonMouseExited
    ...
    private void lbl_thucDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_thucDonMouseClicked
        clearLable();
        pressLable(lbl_thucDon);
        pnl_Main.add(new panel_ThucDon(), "quanlithucdon");
        card.show(this.pnl_Main, "quanlithucdon");
    ...
    private void lbl_thongKeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_thongKeMouseClicked
        clearLable();
        pressLable(lbl_thongKe);
        pnl_Main.add(new panel_ThongKe(), "quanlithongke");
        card.show(this.pnl_Main, "quanlithongke");
            ...
            public void run() {
                ...
                for (int i = 54; i <= 170; i++) {
                    ...
                    try {
                        ...
                        Logger.getLogger(JFrame_MainNVQL.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }).start();
    ...
    public void clearLable() {
        JLabel[] labels = {lbl_trangchu, lbl_banHang, lbl_troGiup, lbl_hoaDon,
            lbl_khachHang, lbl_nhanVien, lbl_thongKe,
            lbl_troGiup, lbl_thucDon};
    ...
    private javax.swing.JLabel lbl_thucDon;
